...
from algorithms.custom_selfishucb import *

# rnd = Selfishucb(environment=Environment(config={"M":2, "K":2, "mu":[0.1,0.9], "horizon":10000, "dynamic":False}, deterministic=False),
#                  randomized=True)

# rnd2 = Custom_Selfishucb(environment=Environment(config={"M":2, "K":2, "mu":[0.1,0.9], "horizon":10000, "dynamic":False}, deterministic=False),
#                  randomized=True)
    ...
    def run_save_fig(self, n_exps, list_algo_to_plot, skip_existing_sim=True):
        ...
        for env in self.list_env:
            ...
            list_algo = [# No collision sensing information
                        ...
                        Exploratory_Randomized_Selfishucb(environment=env, randomized=True),
            ...
            assert len(new_list_algo) != 0, "length is zero"
